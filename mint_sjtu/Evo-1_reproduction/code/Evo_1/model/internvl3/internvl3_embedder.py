...
class InternVL3Embedder(nn.Module):
    def __init__(self, model_name="OpenGVLab/InternVL3-1B", image_size=448, device="cuda", use_flash_attn=True):
        super().__init__()
        self.device = device
    ...
    def get_fused_image_text_embedding_from_tensor_images(
        ...
        embedding = fused_hidden[:, 0, :] if return_cls_only else fused_hidden
